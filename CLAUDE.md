...
<!-- SPECKIT START -->
Current plan: [specs/005-engagement/plan.md](specs/005-engagement/plan.md)
(spec → research → data-model → contracts → quickstart in the same folder).
Roadmap: [phases.md](phases.md). Prior phases: specs/001-nuxt4-ui-upgrade/, specs/002-content-surfaces/, specs/003-social-discovery/, specs/004-search-v2/.
<!-- SPECKIT END -->
