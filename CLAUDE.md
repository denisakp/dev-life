...
<!-- SPECKIT START -->
Current plan: [specs/004-search-v2/plan.md](specs/004-search-v2/plan.md)
(spec → research → data-model → contracts → quickstart in the same folder).
Roadmap: [phases.md](phases.md). Prior phases: specs/001-nuxt4-ui-upgrade/, specs/002-content-surfaces/, specs/003-social-discovery/.
<!-- SPECKIT END -->
