...
description: "From interview challenge to open-source tool, to building a secure password generator with real entropy in mind."
date: 2025-04-13
...
(8 to 64 characters) and generating the requested quantity of passwords: 
```typescript
