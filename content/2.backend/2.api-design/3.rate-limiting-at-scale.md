...
| Accuracy | Exact, real-time | Approximate, ~1–3s stale |
...
| Latency added | 1–2ms+ per request | Effectively zero |
...
- **Relaxing "exact and real-time" to "approximate and slightly stale" changes the whole design.** A 1–3 second lag lets you move enforcement local and delete the shared dependency entirely.
